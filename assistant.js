    ...
    book: {
      ...
      a: function () {
        return 'Займём вам место — выбирайте, как удобнее:' +
          '<div class="rows"><i>· Онлайн</i> — <a href="' + BOOK + '" target="_blank" rel="noopener">на схеме зала</a>, займёт минуту' +
          '<i>· По телефону</i> — ' + CALL + ', администратор подберёт стол' +
          '<i>· Через меня</i> — соберу заявку, вам останется её отправить</div>' +
